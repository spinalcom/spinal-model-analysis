...
export declare function createEndpoint(referenceEpochTime: number, parentId: string, endpointName: string, initialValue: number, unit: string, maxDays: string): Promise<SpinalNodeRef>;
