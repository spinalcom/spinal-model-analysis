...
export declare const CATEGORY_ATTRIBUTE_ENDPOINT_PARAMETERS = "Endpoint creation parameters";
...
export declare const ATTRIBUTE_LAST_EXECUTION_TIME = "lastExecutionTime";
...
export declare const ATTRIBUTE_RESULT_CATEGORY_NAME = "Category name";
export declare const ATTRIBUTE_RESULT_CREATE_ATTRIBUTE_IF_NOT_EXIST = "Create attribute if not exist";
...
export declare const ATTRIBUTE_ANALYTIC_PAST_EXECUTIONS = "Catch up past executions";
