...
exports.FR = {
    ...
    COMPACT_NUMBERS: {
        ...
        description: 'Retire les valeurs nulles, indéfinies et non numériques d\'un tableau de nombres, ne renvoyant que les nombres valides. ' +
    ...
    GENERATE_TIMESTAMPS: {
        ...
        description: 'Construit un tableau d\'horodatages (epoch ms) pour le jour d\'exécution de l\'analytic — à associer ' +
        ...
        inputs: {
            reference: 'Optionnel. Mode GRID : tout tableau dont la longueur définit « count » (ex. la colonne de valeurs, ' +
    ...
    TIMESERIES_DESPIKE: {
        ...
        description: 'Supprime les pics/décrochages transitoires d\'une série temporelle ({ date, value }[]) — par ex. un ' +
