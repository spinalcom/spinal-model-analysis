...
class WorkflowExecutionService {
    ...
    executeBlock(block, context) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if ((0, analysisWorkflowBlock_1.isIterationBlock)(block.algorithmName) && block.subWorkflow) {
                    yield this.executeIteration(block, inputs, context);
                    return;
                }
     ...
     */
    executeIteration(block, inputs, context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!Array.isArray(inputArray)) {
                throw new Error(`${kind} block "${block.name}" expects an array as its first input, ` +
            ...
            if (kind === 'FILTER') {
                ...
                results.forEach((predicate, index) => {
                    if (predicate === true) {
                        ...
                        throw new Error(`FILTER block "${block.name}" expects its sub-workflow output to be a boolean ` +
